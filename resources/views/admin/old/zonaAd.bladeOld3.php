                    ...
                    @if($usuarios)
                     ...
                     <tr>
                        ...
                        <th>
                          ...
                          <form name="form3" action="{{ route('admin.destroy', $usuario->id) }}">
                            @csrf
                            @method('DELETE')
            
                            
                                <input type="submit" class="btn btn-danger" value="Eliminar" name="botEliminar" id="eliminar">
                                
                            
            
                          </form>
                            
                          <a href="{{ route('admin.edit', $usuario->id) }}"><input type="button" name="up" id="up" value="Actualizar"></a>
